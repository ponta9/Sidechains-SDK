...
case class TransactionStorageDataGenerator(inputTransactionsSizeRange: Range,
                                           ...
                                           generatedTransactions: mutable.LinkedHashMap[Int, JPair[ByteArrayWrapper, ByteArrayWrapper]] = mutable.LinkedHashMap())
  ...
  private def generateDataStream(index: Int, counter: Int): Stream[JPair[ByteArrayWrapper, ByteArrayWrapper]] = {
    ...
    val realTransaction = generatedTransactions.getOrElseUpdate(actualIndex, generateTransactionEntry())
  ...
  override def copyGenerator(): StorageDataGenerator = this.copy(generatedTransactions = mutable.LinkedHashMap())
...
case class ByteDataGenerator(byteDataSizeRange: Range,
                             dataMultiplier: Int,
                             generatedData: mutable.LinkedHashMap[Int, JPair[ByteArrayWrapper, ByteArrayWrapper]] = mutable.LinkedHashMap())
  ...
  private def generateDataStream(index: Int, counter: Int): Stream[JPair[ByteArrayWrapper, ByteArrayWrapper]] = {
    ...
    val generatedEntry = generatedData.getOrElseUpdate(index, generateData())
  ...
  override def copyGenerator(): StorageDataGenerator = this.copy(generatedData = mutable.LinkedHashMap())
